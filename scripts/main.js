...
tl({
  ...
  .to(".chap1_des", { paddingTop:'50px',text: "แม้จุดมุ่งหมายจะเหมือนกัน แต่ผู้เข้าแข่งขันที่มาจากต่างครอบครัว ย่อมมีความไม่เท่ากันแต่แรกอยู่แล้ว เปรียบเทียบเหมือนคนที่มีต้นทุนทางสังคม จะเริ่มในจุดที่ใกล้เส้นชัยกว่าคนที่ไม่มีอะไรเลย", ease: "none"}, 0)
  ...
  .to(".hl_2", { display: 'none' })
    .to(".chap1_topic", { text: "ต้องเป็นที่หนึ่งนะลูก", ease: "none", duration: 1 })
    .to(".chap1_des", {  paddingTop:'0px', text: "เราถูกคาดหวังให้เก่ง ให้เร็วกว่าคนอื่น และได้รับรางวัลสูงสุด โดยไม่สร้างความผิดพลาดใด ๆ โดยเฉพาะจากครอบครัวที่หวังให้เรามีอนาคตที่ดี ตามค่านิยมของสังคม", ease: "none"}, 0)
